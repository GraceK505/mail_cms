...
export class TemplateEditorService implements OnInit {
  ...
  async ngOnInit() {
    console.log("html sended", this.pages)
  }
        ...
        this.studio = await createStudioEditor({
              ...
              editor.on("load", async () => {
                ...
                try {
                  if (editor && this.projectData) {
                    ...
                    console.log("editor loaded successfully", pageData)
                  } else {
                    console.warn("Project data is incomplete or editor not ready");
                  }
                } catch (err) {
          ...
          storage: {
            ...
            project: {
              ...
              templates: {
                onLoad: async (): Promise<any> => [...templates],
              },
        });
      } catch (error) {
